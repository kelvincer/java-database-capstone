...
public class PatientService {
    ...
    public ResponseEntity<Map<String, Object>> getPatientAppointment(long id, String token, String user) {
        ...
        try {
            ...
            if(user.equalsIgnoreCase("patient")) {
                optional = patientRepository.findByEmail(email);
            } else if(user.equalsIgnoreCase("doctor")) {
                optional = doctorRepository.findByEmail(email);
            }
            ...
            response.put("error", "Failed to retrieve patient appointment");
    ...
    public ResponseEntity<Map<String, Object>> filterByCondition(String condition, long id) {
        ...
        try {
            ...
            List<Appointment> appointments = appointmentRepository.findByPatient_IdAndStatusOrderByAppointmentTimeAsc(
                    id,
                    status);
            List<AppointmentDTO> dtoList = appointments.stream()
                    .map(AppointmentDTO::new)
